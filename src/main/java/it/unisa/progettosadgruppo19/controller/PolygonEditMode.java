...
/**
 * Utility class per supportare l'editing avanzato dei poligoni.
 * Fornisce metodi per rilevare vertici, gestire handle di editing e validazioni.
 */
public class PolygonEditMode {
     ...
     * @param x coordinata X del punto
     * @param y coordinata Y del punto
     * @return indice del vertice (0-based) o -1 se nessun vertice è abbastanza vicino
     */
     ...
     *
     * @param polygon poligono da modificare
     * @param afterVertexIndex indice del vertice dopo il quale inserire il nuovo vertice
