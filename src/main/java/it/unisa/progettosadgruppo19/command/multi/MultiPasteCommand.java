 ...
 * Supporta sia il clipboard standard che quello multiplo gestito da
 * MultiClipboardManager.
 *
...
public class MultiPasteCommand implements UndoableCommand {
     ...
     * @param useMultiClipboard se true, tenta di incollare da clipboard
     * multiplo
     */
    ...
    /**
     * Costruttore semplificato che usa automaticamente clipboard multiplo se
     * disponibile.
     */
    ...
    /**
     * Annulla l'incollaggio rimuovendo tutte le shape precedentemente
     * incollate.
     */
    @Override
    public void undo() {
