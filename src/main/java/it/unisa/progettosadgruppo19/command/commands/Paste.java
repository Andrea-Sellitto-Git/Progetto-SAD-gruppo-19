...
/**
 * Comando undoable per incollare una {@link Shape} salvata nel clipboard in una
 * posizione definita, creando una copia completamente indipendente.
 */
public class Paste implements UndoableCommand {
    ...
    /**
     * Costruisce un comando Paste che incolla la shape alle coordinate
     * specificate.
     *
     * @param clipboard il receiver del clipboard da cui recuperare la shape;
    ...
    /**
     * Esegue l'incollaggio: preleva la shape dal clipboard, crea una copia
     * completamente indipendente, la posiziona alle coordinate specificate e la
     * aggiunge al manager.
     */
    @Override
    public void execute() {
    ...
    /**
     * Crea una copia completamente indipendente della shape originale. Questa
     * copia non condivide alcun riferimento con l'originale.
     */
    ...
    /**
     * Annulla l'incollaggio rimuovendo la shape precedentemente incollata, se
     * presente.
     */
    @Override
    public void undo() {
